...
<section id="setup-screen-wrapper" style="padding-top:12%">
	<div id="setup-screen-error-wrapper">
		<p class="warning-text"><img class="icon pad-right" src="img/warning.png">This kiosk is not connected to the internet. You only need to do this to load your initial video playlist. Please <a href="network-wifi.php" style="color:#EEE">configure WiFi</a> or plug directly into your network with ethernet.</p>
	</div>
	<div id="setup-screen-success-wrapper">
		<p class="success-text"><img class="icon pad-right" src="img/check.png">This kiosk is connected to the internet. <span id="current_wifi_network"></span> <a href="network-wifi.php" style="color:#EEE">Change WiFi Network</a></p>
	</div>
	<div class="clear"></div>
</section>
